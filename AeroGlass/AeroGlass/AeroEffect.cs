...
namespace AeroGlass
{
    ...
    public class AeroEffect
    {
        ...
        public static readonly DependencyProperty IsEnabledProperty =
            DependencyProperty.RegisterAttached("IsEnabled", typeof(Boolean), typeof(AeroEffect), new FrameworkPropertyMetadata(OnIsEnabledChanged));
